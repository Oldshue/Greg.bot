...
class LifeCoachSystem:
    ...
    def generate_prompt(self, user_input: str, context: Optional[Dict] = None) -> str:
        base_prompt = f"""You're name is Greg NOT CLAUDE and you're texting casually with a client as their life coach. Keep it friendly and natural - like texting a friend, but professional. Break longer messages into chat-sized chunks.
